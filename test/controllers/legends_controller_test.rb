...
class LegendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create legend" do
    assert_difference('Legend.count') do
      post legends_url, params: { legend: { email: @legend.email, name: @legend.name, phone: @legend.phone } }
    end
  ...
  test "should update legend" do
    patch legend_url(@legend), params: { legend: { email: @legend.email, name: @legend.name, phone: @legend.phone } }
